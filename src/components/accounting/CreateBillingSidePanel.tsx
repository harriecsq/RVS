...
import { CreateBillingScreen } from "./CreateBillingModal";

interface CreateBillingSidePanelProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
...
export function CreateBillingSidePanel({
  isOpen,
  onClose,
  onSuccess,
  prefillProjectId,
  ...
  return (
    <>
      ...
      >
        ...
        {/* Content - CreateBillingScreen fills the panel */}
        <div style={{ flex: 1, overflow: "auto" }}>
          <CreateBillingScreen
            ...
            prefillProjectNumber={prefillProjectNumber}
