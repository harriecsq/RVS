...
import { Download, Filter, Plus, X, ChevronUp, ChevronDown, BarChart, FileText } from 'lucide-react';
...
const DATA_SOURCES = [
  ...
  { id: 'customers' as DataSource, label: 'Clients', icon: '👤', description: 'Client database' },
  ...
  { id: 'budget_requests' as DataSource, label: 'Budget Requests', icon: '💰', description: 'All budget requests' },
];
...
export function ReportsModule() {
  ...
  return (
    <div className="h-full flex flex-col overflow-auto" style={{ background: '#FFFFFF' }}>
      <div style={{ padding: '32px 48px', maxWidth: '1440px', width: '100%', margin: '0 auto' }}>
        {/* Header */}
      ...
      {/* Results Table */}
      <div className="flex-1 overflow-auto" style={{ padding: '0 48px 48px 48px', maxWidth: '1440px', width: '100%', margin: '0 auto' }}>
        {isLoading ? (
      ...
      {/* Save Report Button */}
      <div style={{ padding: '0 48px 32px 48px', maxWidth: '1440px', width: '100%', margin: '0 auto' }}>
        <button
