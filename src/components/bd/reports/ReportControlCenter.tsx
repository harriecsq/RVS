...
import { ChevronDown, ChevronRight, Search, Plus, X, Download, Play } from 'lucide-react';
...
const ALL_FIELDS: FieldDef[] = [
  ...
  // Customers
  { entity: 'customers', field: 'id', label: 'Client ID', type: 'text' },
  { entity: 'customers', field: 'company_name', label: 'Client Name', type: 'text' },
  { entity: 'customers', field: 'industry', label: 'Client Industry', type: 'text' },
  { entity: 'customers', field: 'country', label: 'Client Country', type: 'text' },
  { entity: 'customers', field: 'status', label: 'Client Status', type: 'select', options: ['Active', 'Inactive', 'Lead'] },
  { entity: 'customers', field: 'created_at', label: 'Client Created Date', type: 'date' },
  { entity: 'customers', field: 'updated_at', label: 'Client Updated Date', type: 'date' },
...
export function ReportControlCenter({ onBack }: ReportControlCenterProps) {
  ...
  return (
    <div className="h-full flex flex-col overflow-auto" style={{ background: '#FFFFFF', padding: '32px 48px', maxWidth: '1440px', width: '100%', margin: '0 auto' }}>
      {/* Header */}
