...
import { buildDeclarationDefaults } from "../../../utils/export-document-autofill";
...
export function DeclarationTab({ bookingId, booking, currentUser, onDocumentUpdated }: DeclarationTabProps) {
    ...
    <div style={{ padding: "32px 48px", overflow: "auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
        <h2 style={{ fontSize: "18px", fontWeight: 600, color: "#0A1D4D", margin: 0 }}>
          Declaration {(doc?.refNo || (isEditing && buildRefNo())) && <span style={{ color: "#667085", fontWeight: 400 }}>— {isEditing ? buildRefNo() : doc?.refNo}</span>}
        </h2>
