    ...
    <>
      ...
      >
        ...
        >
              ...
              <div className="flex-1 overflow-auto">
                ...
                <div className="bg-white">
                  ...
                  <div className="grid grid-cols-8 border-l border-[#E5E9F0]">
                    ...
                    <div className="col-span-2 border-r border-b border-[#E5E9F0] p-3 bg-white" style={{ minHeight: "56px" }}></div>
                    <div className="col-span-6 border-r border-b border-[#E5E9F0] p-3 flex items-center justify-center bg-white" style={{ minHeight: "56px" }}>
                    ...
                    <div className="col-span-2 border-r border-b border-[#E5E9F0] p-3 bg-[#F9FAFB] flex items-center justify-center" style={{ height: "40px" }}>
                      <p className="text-[12px] text-[#0A1D4D] uppercase tracking-wide" style={{ fontWeight: 700 }}>
                        {isImport ? 'IMPORT' : 'EXPORT'}
                      </p>
                    </div>
                    <div className="col-span-4 border-r border-b border-[#E5E9F0]" style={{ height: "40px" }}></div>
                    <div className="col-span-2 border-r border-b border-[#E5E9F0] p-3 flex items-center justify-end" style={{ height: "40px" }}>
                    ...
                    {/* Row 3: Mode Headers */}
                    <div className="border-r border-b border-[#E5E9F0] bg-[#F9FAFB]" style={{ height: "36px" }}></div>
                    <div className="border-r border-b border-[#E5E9F0] p-2 bg-[#F9FAFB] flex items-center justify-center" style={{ height: "36px" }}>
                    ...
                    <div className="col-span-4 border-r border-b border-[#E5E9F0] p-2 bg-[#F9FAFB] flex items-center justify-center" style={{ height: "36px" }}>
                      <p className="text-[11px] text-[#0A1D4D] uppercase tracking-wide" style={{ fontWeight: 700 }}>TRUCKING</p>
                    </div>

                    {/* Row 4: FCL Checkboxes */}
                    <div className="border-r border-b border-[#E5E9F0] p-2 flex items-center justify-center" style={{ height: "36px" }}>
                      <p className="text-[11px] text-[#64748B]" style={{ fontWeight: 600 }}>FCL</p>
                    </div>
                    <div className="border-r border-b border-[#E5E9F0] flex items-center justify-center" style={{ height: "36px" }}>
                    ...
                    <div className="col-span-4 border-r border-b border-[#E5E9F0] flex items-center justify-center" style={{ height: "36px" }}>
                    ...
                    {Array.from({ length: 8 }).map((_, i) => (
                      <div key={`div1-${i}`} className="border-r border-b border-[#E5E9F0]" style={{ height: "12px" }}></div>
                    ))}

                    {/* Row 7: SHIPPER */}
                    <div className="col-span-3 border-r border-b border-[#E5E9F0] p-3 bg-[#F9FAFB] flex items-center" style={{ height: "40px" }}>
                      <p className="text-[11px] text-[#0A1D4D] uppercase tracking-wide" style={{ fontWeight: 700 }}>SHIPPER:</p>
                    </div>
                    <div className="col-span-5 border-r border-b border-[#E5E9F0] p-3 flex items-center" style={{ height: "40px" }}>
                    ...
                    {/* Row 9: ETD / ETA */}
                    <div className="col-span-1 border-r border-b border-[#E5E9F0] p-3 bg-[#F9FAFB] flex items-center" style={{ height: "40px" }}>
                      <p className="text-[11px] text-[#0A1D4D] uppercase tracking-wide" style={{ fontWeight: 700 }}>ETD:</p>
                    </div>
                    <div className="col-span-2 border-r border-b border-[#E5E9F0] p-3 flex items-center" style={{ height: "40px" }}>
                      <p className="text-[13px] text-[#0A1D4D]" style={{ fontWeight: 700 }}>{formatDate(shipmentData.etd)}</p>
                    </div>
                    <div className="col-span-2 border-r border-b border-[#E5E9F0] p-3 bg-[#F9FAFB] flex items-center" style={{ height: "40px" }}>
                      <p className="text-[11px] text-[#0A1D4D] uppercase tracking-wide" style={{ fontWeight: 700 }}>ETA:</p>
                    </div>
                    <div className="col-span-3 border-r border-b border-[#E5E9F0] p-3 flex items-center" style={{ height: "40px" }}>
                    ...
                    {Array.from({ length: 8 }).map((_, i) => (
                      <div key={`div2-${i}`} className="border-r border-b border-[#E5E9F0]" style={{ height: "12px" }}></div>
                    ))}

                    {/* Row 21-23: SPECIAL INSTRUCTION */}
                    <div className="col-span-3 border-r border-b border-[#E5E9F0] p-3 bg-[#F9FAFB] flex items-start pt-3" style={{ minHeight: "120px" }}>
                      <p className="text-[11px] text-[#0A1D4D] uppercase tracking-wide" style={{ fontWeight: 700 }}>SPECIAL INSTRUCTION:</p>
                    </div>
                    <div className="col-span-5 border-r border-b border-[#E5E9F0] p-3" style={{ minHeight: "120px" }}>
                    ...
                    {Array.from({ length: 20 }).map((_, rowIdx) => (
                      Array.from({ length: 8 }).map((_, colIdx) => (
                        <div key={`extra-${rowIdx}-${colIdx}`} className="border-r border-b border-[#E5E9F0]" style={{ height: "36px" }}></div>
                      ))
                    ))}
                  </div>
                </div>
          ...
          <div className="excel-controls border-t border-[#E5E9F0] px-6 py-4 flex items-center justify-end gap-3 bg-white flex-shrink-0">
            <Button
              onClick={handlePrint}
            ...
            <Button
              onClick={onClose}
              variant="outline"
              className="border-[#E5E9F0] hover:border-[#0A1D4D] hover:bg-[#0A1D4D]/5 rounded-lg h-10 px-4"
            >
