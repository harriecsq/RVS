...
export function PngUploadSlot({ label, value, onChange, readOnly = false }: PngUploadSlotProps) {
    ...
    <div style={{ marginBottom: "12px" }}>
      ...
      {value ? (
        ...
        >
          ...
          <span style={{ fontSize: "11px", color: "#9CA3AF" }}>{readOnly ? "No seal uploaded" : "Upload PNG"}</span>
        </div>
      )}
      <input
        ref={inputRef}
