...
- Primary teal: `#0F766E` (brand)
- Hover teal: `#0D6B64`
- Light teal surface: `#E8F5F3` / mint header `#E5F4F2`
- Deep green (headers, important): `#12332B`
- Ink primary: `#0A1D4D` (navy — note: project reads as "green brand" but ink is navy, very distinctive combo)
- Ink secondary: `#344054`, muted: `#667085`
- Border: `#E5E9F0`, divider: `#EEF1F5`
- Semantic: success `#0F766E`, warn `#F59E0B`, danger `#EF4444`, info `#3B82F6`
